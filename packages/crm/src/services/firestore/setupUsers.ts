...
const INITIAL_USERS: InitialUser[] = [
  ...
  },
  {
    ...
    password: import.meta.env.VITE_SALES_PASSWORD || 'sales123',
    name: 'John Sales',
    role: 'sales_agent',
  },
  {
    email: 'sara@aspcranes.com',
    password: import.meta.env.VITE_MANAGER_PASSWORD || 'manager123',
    name: 'Sara Manager',
    role: 'operations_manager',
  },
  {
    email: 'mike@aspcranes.com',
    password: import.meta.env.VITE_OPERATOR_PASSWORD || 'operator123',
    name: 'Mike Operator',
    role: 'operator',
  },
];
